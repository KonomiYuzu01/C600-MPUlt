...
Download the Windows x64 portable ZIP, extract it, and run Magic600Cell.exe. No separate Python or compiler is required. Microsoft Managed DirectX remains an external prerequisite; see DIRECTX.md.
...
See the release assets for the portable ZIP, recordings and SHA256SUMS.txt.
